 ...
 * Suporta ambiente de desenvolvimento e produção
 * 
 * VERSÃO: 2.1 - Suporte a Dev e Prod
 * 
 * ALTERAÇÕES NESTA VERSÃO:
 * - Detecção automática de ambiente (dev vs prod)
 * - Carregamento de dev_config.php em desenvolvimento
 * - Credenciais separadas para dev e prod
...
// Carregar configurações de desenvolvimento se necessário
if ($is_dev) {
...
// ==================== FIM CONFIGURAÇÕES POR AMBIENTE ====================
...
// class.php está no mesmo diretório
...
// ==================== FIM CREDENCIAIS POR AMBIENTE ====================

try {
    // Usar CRM real (dev ou prod)
