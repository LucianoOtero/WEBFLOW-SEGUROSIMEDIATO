...
(function() {
  ...
  function validarPlacaApi(placa) {
    ...
    return fetch('./placa-validate.php', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
    ...
    function init() {
      ...
      function loadRPAScript() {
        return new Promise((resolve, reject) => {
          ...
          script.src = './webflow_injection_limpo.js';
          script.onload = () => {
      ...
      function loadWhatsAppModal() {
        ...
        const script = document.createElement('script');
        script.src = './MODAL_WHATSAPP_DEFINITIVO.js?v=24&force=' + Math.random();
