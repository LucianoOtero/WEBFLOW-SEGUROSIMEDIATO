 ...
 * - URLs atualizadas para endpoints .php (caminhos relativos)
 * 
...
$(function() {
  ...
  function getEndpointUrl(endpoint) {
    // Endpoints unificados - caminhos relativos
    const endpoints = {
      travelangels: './add_travelangels.php',
      octadesk: './add_webflow_octa.php'
    };
    
    const url = endpoints[endpoint] || './add_flyingdonkeys.php';
  ...
  async function sendAdminEmailNotification(modalPayload, responseData, errorInfo = null) {
    try {
      ...
      // Endpoint de email - caminho relativo
      const emailEndpoint = './send_email_notification_endpoint.php';
