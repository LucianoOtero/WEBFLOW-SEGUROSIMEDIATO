...
(function() {
    ...
    ;
        ...
        async console.log('🔍 [VALIDACAO] Validando via API...');
    ...
    class MainPage {
        ...
        "`);
            ...
            // Converter sexo
            if (data.SEXO) {
                data.sexo = this." → "${data.sexo}"`);
            }
            
            // Converter tipo de veículo
            if (data['TIPO-DE-VEICULO']) {
                data.tipo_veiculo = this." → "${data.tipo_veiculo}"`);
            }
