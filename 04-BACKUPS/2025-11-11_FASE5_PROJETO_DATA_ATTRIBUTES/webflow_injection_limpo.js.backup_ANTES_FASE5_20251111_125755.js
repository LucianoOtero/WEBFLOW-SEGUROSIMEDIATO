...
(function() {
    ...
    class MainPage {
        ...
        convertEstadoCivil(webflowValue) {
            ...
            console.log(`🔍 Convertendo estado civil: "${webflowValue}" → "${normalized}"`);
        ...
        convertSexo(webflowValue) {
            const normalized = webflowValue.toLowerCase().trim();
            console.log(`🔍 Convertendo sexo: "${webflowValue}" → "${normalized}"`);
        ...
        convertTipoVeiculo(webflowValue) {
            ...
            console.log(`🔍 Convertendo tipo de veículo: "${webflowValue}" → "${tipo}"`);
    ...
    if (!document.querySelector('script[src*="sweetalert2"]')) {
        ...
        console.log('🎨 SweetAlert2 v11.14.0 carregado');
    }
