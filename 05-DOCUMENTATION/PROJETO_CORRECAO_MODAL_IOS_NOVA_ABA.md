...
**📚 BASEADO EM:** `02-DEVELOPMENT/PESQUISA_SOLUCOES_VALIDADAS_FONTES_REFERENCIA.md`
...
1. **`02-DEVELOPMENT/custom-codes/FooterCodeSiteDefinitivoCompleto_prod.js`**
   - **Localização:** Arquivo local (Windows)
   - **Localização no Servidor DEV:** `/var/www/html/dev/webhooks/FooterCodeSiteDefinitivoCompleto_prod.js`
...
- ✅ `FooterCodeSiteDefinitivoCompleto_prod.js.backup_CORRECAO_IOS_MODAL_20251105_010000` (será criado antes da modificação)
- ✅ `MODAL_WHATSAPP_DEFINITIVO.js.backup_CORRECAO_IOS_MODAL_20251105_010000` (será criado antes da modificação)

### Arquivos de Referência (NÃO MODIFICAR):
- `02-DEVELOPMENT/PESQUISA_SOLUCOES_VALIDADAS_FONTES_REFERENCIA.md` - Base técnica do projeto
- `02-DEVELOPMENT/ANALISE_RISCOS_SOLUCOES_IOS_ANDROID_DESKTOP.md` - Análise de riscos
...
Copy-Item "02-DEVELOPMENT/custom-codes/FooterCodeSiteDefinitivoCompleto_prod.js" "02-DEVELOPMENT/custom-codes/FooterCodeSiteDefinitivoCompleto_prod.js.backup_CORRECAO_IOS_MODAL_$timestamp"

# Criar backup do Modal
Copy-Item "MODAL_WHATSAPP_DEFINITIVO.js" "MODAL_WHATSAPP_DEFINITIVO.js.backup_CORRECAO_IOS_MODAL_$timestamp"

# Verificar backups criados
Get-Item "02-DEVELOPMENT/custom-codes/FooterCodeSiteDefinitivoCompleto_prod.js.backup_CORRECAO_IOS_MODAL_*" | Select-Object Name, Length, LastWriteTime
Get-Item "MODAL_WHATSAPP_DEFINITIVO.js.backup_CORRECAO_IOS_MODAL_*" | Select-Object Name, Length, LastWriteTime
```
...
### **2.1 Modificar `FooterCodeSiteDefinitivoCompleto_prod.js` (Arquivo DEV Local)**
...
### **2.2 Modificar `MODAL_WHATSAPP_DEFINITIVO.js` (Arquivo DEV Local)**
...
scp "02-DEVELOPMENT/custom-codes/FooterCodeSiteDefinitivoCompleto_prod.js" root@46.62.174.150:/var/www/html/dev/webhooks/
...
ssh root@46.62.174.150 "chmod 644 /var/www/html/dev/webhooks/FooterCodeSiteDefinitivoCompleto_prod.js && chmod 644 /var/www/html/dev/webhooks/MODAL_WHATSAPP_DEFINITIVO.js && ls -lh /var/www/html/dev/webhooks/FooterCodeSiteDefinitivoCompleto_prod.js /var/www/html/dev/webhooks/MODAL_WHATSAPP_DEFINITIVO.js"
```
...
# Copiar FooterCode para servidor PROD
scp "02-DEVELOPMENT/custom-codes/FooterCodeSiteDefinitivoCompleto_prod.js" root@46.62.174.150:/var/www/html/webhooks/

# Copiar Modal para servidor PROD
scp "MODAL_WHATSAPP_DEFINITIVO.js" root@46.62.174.150:/var/www/html/webhooks/
...
Get-ChildItem "02-DEVELOPMENT/custom-codes/FooterCodeSiteDefinitivoCompleto_prod.js.backup_CORRECAO_IOS_MODAL_*" | Sort-Object LastWriteTime -Descending | Select-Object -First 1
Get-ChildItem "MODAL_WHATSAPP_DEFINITIVO.js.backup_CORRECAO_IOS_MODAL_*" | Sort-Object LastWriteTime -Descending | Select-Object -First 1

# Restaurar FooterCode (substituir pelo timestamp correto)
$backupFooter = "02-DEVELOPMENT/custom-codes/FooterCodeSiteDefinitivoCompleto_prod.js.backup_CORRECAO_IOS_MODAL_20251105_010000"
Copy-Item $backupFooter "02-DEVELOPMENT/custom-codes/FooterCodeSiteDefinitivoCompleto_prod.js" -Force

# Restaurar Modal (substituir pelo timestamp correto)
$backupModal = "MODAL_WHATSAPP_DEFINITIVO.js.backup_CORRECAO_IOS_MODAL_20251105_010000"
Copy-Item $backupModal "MODAL_WHATSAPP_DEFINITIVO.js" -Force
...
ssh root@46.62.174.150 "ls -lh /var/www/html/dev/webhooks/FooterCodeSiteDefinitivoCompleto_prod.js /var/www/html/dev/webhooks/MODAL_WHATSAPP_DEFINITIVO.js"
```
